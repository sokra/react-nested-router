...
var copyProperties = require('../helpers/copyProperties');
...
var Route = React.createClass({
  ...
  componentDidMount: function () {
    this.dispatch(this.props.initialPath || URLStore.getCurrentPath());
  },
...
function findMatches(path, route) {
  var matches, children = route.props.children;
  ...
  if (matches) {
    ...
    var params = copyProperties(rootParams, Path.extractParamNames(route.props.path));
